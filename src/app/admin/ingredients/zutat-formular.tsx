...
import { TextField, NumberField, SelectField, CheckboxRow, CheckboxGroup } from "../_components/form-fields";
import { ZUTAT_KATEGORIEN, ALLERGENE_LISTE, ZUSATZSTOFFE_LISTE } from "@/lib/data";
import type { Zutat, Einheit } from "@/lib/types";
