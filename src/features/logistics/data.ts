...
export const lieferRoutenSeed: LieferRoute[] = [
  {
    ...
    stopps: [{
      ...
      positionen: [{ id: "pack-1", rezeptId: "r-088", portionen: 145, behaelter: "10 × GN 1/1", temperatur: "mind. 65 °C" }],
    }],
  },
  {
    ...
    stopps: [
      { id: "stop-sued-1", einrichtungId: "f-002", reihenfolge: 1, ankunft: "10:40", zeitfenster: "10:35–10:50", kontakt: "Frank Otten", telefon: "0211 555 202", hinweis: "Rampe an der Südseite nutzen.", positionen: [{ id: "pack-2", rezeptId: "r-088", portionen: 98, behaelter: "7 × GN 1/1", temperatur: "mind. 65 °C" }] },
      { id: "stop-sued-2", einrichtungId: "f-003", reihenfolge: 2, ankunft: "11:15", zeitfenster: "11:10–11:25", kontakt: "Hanna Bruns", telefon: "0211 555 303", hinweis: "Bitte an der Küchentür klingeln.", positionen: [{ id: "pack-3", rezeptId: "r-001", portionen: 60, behaelter: "4 × GN 1/1", temperatur: "mind. 65 °C", hinweis: "Allergenkennzeichnung Eier und Milch prüfen" }] },
    ],
  },
];
